...
package struct VoiceInputFailurePresentation {
    ...
    package let settingsDestination: SettingsGroup?
...
extension VoiceInputFailure {
    ...
    package var needsSettings: Bool { settingsDestination != nil }
    package var settingsDestination: SettingsGroup? { appPresentation.settingsDestination }
